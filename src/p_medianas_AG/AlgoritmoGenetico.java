...
public class AlgoritmoGenetico {
    ...
    private String caminho_arquivo_texto;
    private int[] mais_proximo;
    private double melhor_custo;

    public AlgoritmoGenetico(double[][] custos, int tot_facilidades, int tot_pontos_demanda, int qtde_facilidades_usar, int tamanho_populacao) throws IOException {
        this.custos = custos;
    ...
    private void run_AG() throws IOException {
        //para marcar o tempo
        ...
        this.tempo_gasto = (System.currentTimeMillis() - inicio);
        ...
        String resultado = this.tot_pontos_demanda + ", " + this.tot_facilidades + ", " + this.qtde_facilidades_usar + ", " + this.melhor_custo + ", " + iteracao + ", " + this.sem_melhoria + ", "+ this.tempo_gasto+"\n";
        escritor("/home/lsiqueira/IFF Sistemas/Inteligência Computacional/P2/P_medianas_AG/relatorios/resultados.txt", resultado);
    }
